...
class InvoiceController extends AbstractController
{
    ...
    {
        // Get proformas that can be converted (not already converted)
    ...
    {
        $settings = $this->settingsRepository->getSettings();
        $numberToWords = new NumberToWordsService();
        
        return $this->render('invoice/show.html.twig', [
            'invoice' => $invoice,
            'settings' => $settings,
            'totalInWords' => $numberToWords->convert($invoice->getTotalTTCFloat(), $settings?->getCurrency() ?? 'FCFA'),
        ]);
    }
    ...
    public function whatsapp(Invoice $invoice): Response
    {
        ...
        return $this->render('invoice/whatsapp_redirect.html.twig', [
            'whatsapp_url' => $url,
            'invoice' => $invoice,
        ]);
    }
