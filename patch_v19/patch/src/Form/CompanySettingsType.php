...
class CompanySettingsType extends AbstractType
{
        ...
        $builder
            ...
            ->add('faviconFile', FileType::class, [
                ...
                'constraints' => [
                    new File([
                        'maxSize' => '512k',
                        'mimeTypes' => ['image/png', 'image/x-icon', 'image/svg+xml', 'image/vnd.microsoft.icon'],
    ...
    private function buildInvoicingFields(FormBuilderInterface $builder): void
    {
        $builder
            ...
            // NOUVEAU CHAMP: Marge par défaut
            ->add('defaultMargin', NumberType::class, [
                ...
                'help' => 'Marge appliquée automatiquement aux nouveaux produits',
            ])
