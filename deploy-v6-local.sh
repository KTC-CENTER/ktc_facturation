#!/bin/bash
# ============================================================================
# KTC-Invoice Pro - Local Deployment Script v6
# ============================================================================
set -e

CONTAINER="ktc-invoice-app-local"
ARCHIVE="ktc-fixes-v6-complete.tar.gz"
...
docker exec "$CONTAINER" bash -c "chown -R 1000:1000 $APP_DIR/var/ $APP_DIR/public/uploads/ 2>/dev/null || true"

echo "🧹 Warming cache..."
docker exec "$CONTAINER" bash -c "cd $APP_DIR && php bin/console cache:clear 2>&1 || true"
docker exec "$CONTAINER" bash -c "cd $APP_DIR && php bin/console cache:warmup 2>&1 || true"
...
echo ""
echo "============================================"
echo " ✅ Deployment v6 COMPLETE! (70 files)"
echo "============================================"
echo ""
echo " BUGS CORRIGÉS:"
echo "  1. ✅ sortOrder null error"
echo "  2. ✅ discount null error"  
echo "  3. ✅ ProformaTemplate getConditions error"
echo "  4. ✅ Modèles -> ProformaTemplateController"
echo "  5. ✅ Modal partage corrigé"
echo ""
echo " NOUVELLES FONCTIONNALITÉS:"
echo "  6. ✅ Envoi Email/WhatsApp direct (facture/proforma)"
echo "  7. ✅ Gestion modèles de proforma"
echo "  8. ✅ CI/CD GitHub Actions"
echo "  9. ✅ Docker production avec SSL"
echo ""
